        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">
                        {{ trans('global.edit') }} {{ trans('locale.role.title_singular') }}
                    </h4>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    @endif
                                    <p><small
                                            class="text-muted">{{ trans('locale.role.fields.title_helper') }}</small>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    @endif
                                    <p><small
                                            class="text-muted">{{ trans('locale.role.fields.permissions_helper') }}</small>
                                    </p>
                                </div>
                            </div>
                        </div>
